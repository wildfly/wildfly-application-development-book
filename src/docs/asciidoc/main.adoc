...
The following guide provides instructions for creating from scratch, deploying, and testing Jakarta EE applications on {ProductShortName} running on different platforms.

//{ProductShortName} uses Maven as the project management tool. 

The first four chapters guide you through the following stages:
...
* Building and deploying the Hello World Servlet to {ProductShortName} running on bare metal and {CloudPlatform}.
* Testing the Hello World Servlet to {ProductShortName} running on bare metal and {CloudPlatform}.

The subsequent chapters guide you through creating applications based on other Jakarta EE technologies. 
