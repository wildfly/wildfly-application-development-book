...
:_template-generated: 2024-09-27

ifdef::context[:parent-context-of-building-and-deploying-a-servlet-application: {context}]

:_mod-docs-content-type: ASSEMBLY

ifndef::context[]
[id="building-and-deploying-a-servlet-application"]
endif::[]
ifdef::context[]
[id="building-and-deploying-a-servlet-application_{context}"]
endif::[]
= Building and deploying a servlet application

:context: building-and-deploying-a-servlet-application
...
ifdef::parent-context-of-building-and-deploying-a-servlet-application[:context: {parent-context-of-building-and-deploying-a-servlet-application}]
ifndef::parent-context-of-building-and-deploying-a-servlet-application[:!context:]
