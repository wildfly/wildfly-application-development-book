...
----
$ mkdir -p src/test/java/org/jboss/as/quickstarts/__<pjoject_name>__
----
...
[source,options="nowrap",subs=+quotes]
----
$ cd src/test/java/org/jboss/as/quickstarts/__<pjoject_name>__
----
...
----
<1> The URL at which the application is running. This value is used if `sever.host` is undefined. Replace __<expected_url>__ with the URL you defined in the application.
...
<5> Test that the response received from the application is "200" indicating that the application is reachable.
