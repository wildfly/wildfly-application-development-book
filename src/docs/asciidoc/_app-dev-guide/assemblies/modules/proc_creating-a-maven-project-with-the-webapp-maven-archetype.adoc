...
<2> Replace _<project-name>_ with a name for the project. This name is used the generated `jar` archive.
...
. Remove the content inside the `<project>` section of `pom.xml` configuration file after the `<name>__{project_name}__ Maven Webapp</name>` line.
+
